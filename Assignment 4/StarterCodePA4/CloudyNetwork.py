...
class CloudyNetwork(object):
    ...
    def main(cls, args):
        ...
        given3[rain]= True
        given3[cloudy]=True
        given3[sprinkler]=True
        given3[wetGrass]=True
        print("weighted sampling: " + str(cloudnet.performWeightedSampling(wetGrass, given3, 99999)))
        print("rejection sampling: " + str(cloudnet.performRejectionSampling(wetGrass, given3, 999999)))
        print("gibbs sampling: " + str(cloudnet.performGibbsSampling(wetGrass, given3, 99999)))

        print("Test 4")
        given4 = {}
        given4[sprinkler]=True
        given4[wetGrass]=True
        print("weighted sampling: " + str(cloudnet.performWeightedSampling(sprinkler, given4, 99999)))
        print("rejection sampling: " + str(cloudnet.performRejectionSampling(sprinkler, given4, 999999)))
        print("gibbs sampling: " + str(cloudnet.performGibbsSampling(sprinkler, given4, 99999)))

        print("Test 5")
        given5 = {}
        given5[wetGrass]=True
        print("weighted sampling: " + str(cloudnet.performWeightedSampling(wetGrass, given5, 99999)))
        print("rejection sampling: " + str(cloudnet.performRejectionSampling(wetGrass, given5, 999999)))
        print("gibbs sampling: " + str(cloudnet.performGibbsSampling(wetGrass, given5, 99999)))
